        ...
        <fieldset class="search-container" style="text-align: center;margin: 30px 0;">
          <form class="layui-form">
            ...
            <div class="layui-inline" style="margin-bottom: 10px;">
              ...
              <div class="layui-input-inline">
                <input type="text" name="yonghupingfen" id="yonghupingfen" placeholder="用户评分" autocomplete="off" class="layui-input">
              </div>
            </div>   
            <div class="layui-inline" style="margin-bottom: 10px;">
            ...
            <div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
              ...
              <button v-if="isAuth('dingdanpingjia','新增')" @click="jump('../dingdanpingjia/add.jsp')" type="button" class="layui-btn btn-theme">
        ...
        <div class="pro-lists-con">
          <ul class="after">
            <li v-for="(item,index) in dataList" v-bind:key="index">
              <a target="_self" :href="'../dingdanpingjia/detail.jsp?id='+item.id">
                <div class="posi-img">
                </div>
                <div class="remark">
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#yonghupingfen').val()) {
          param['yonghupingfen'] = jquery('#yonghupingfen').val() ? '%' + jquery('#yonghupingfen').val() + '%' : '';
        }  
        if (jquery('#yonghuming').val()) {
          param['yonghuming'] = jquery('#yonghuming').val() ? '%' + jquery('#yonghuming').val() + '%' : '';
        }  
        // 获取列表数据
        http.request('dingdanpingjia/list', 'get', param, function(res) {
