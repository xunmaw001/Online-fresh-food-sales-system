						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<select name="shangpinmingcheng" id="shangpinmingcheng">
									...
									<option v-for="(item,index) in shangpinmingcheng" v-bind:key="index" :value="item">{{item}}</option>
								</select>
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							...
							<div class="layui-input-block">
								<select name="yonghupingfen" id="yonghupingfen">
									...
									<option v-for="(item,index) in yonghupingfen" v-bind:key="index" :value="item">{{item}}</option>
                                                                                                ...
                                                                                                <div class="layui-form-item">
							<div class="layui-input-block">
								<img id="tianjiatupianImg" style="width: 100px;height: 100px;border-radius: 50%;border: 2px solid #EEEEEE;" src="../../img/avator.png">
								<input type="hidden" id="tianjiatupian" name="tianjiatupian" />
							</div>
						</div>
						<div class="layui-form-item">
							<div class="layui-input-block">
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload'], function() {
				...
				http.request(`${table}/session`, 'get', {}, function(data) {
					...
					form.val("myForm", data.data);
																																													// 图片赋值
					jquery("#tianjiatupianImg").attr("src", data.data.tianjiatupian);
																																																																										});
