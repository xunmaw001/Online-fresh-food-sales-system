...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<select name="shangpinmingcheng" id="shangpinmingchengSelect" class="form-control form-control-sm" aria-controls="tableId">
									</select>
									<label>
										用户评分
									</label>
									<select name="yonghupingfen" id="yonghupingfenSelect" class="form-control form-control-sm" aria-controls="tableId">
										<option value=" "> </option>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			var shangpinmingchengIndex = document.getElementById("shangpinmingchengSelect").selectedIndex;
			var shangpinmingchengOptions = document.getElementById("shangpinmingchengSelect").options;
			var shangpinmingchengSelectedOption = shangpinmingchengOptions[shangpinmingchengIndex]
			if(shangpinmingchengSelectedOption.text != null && shangpinmingchengSelectedOption.text != ''){
				searchForm.shangpinmingcheng = "%" + shangpinmingchengSelectedOption.text + "%";
			}
			var yonghupingfenIndex = document.getElementById("yonghupingfenSelect").selectedIndex;
			var yonghupingfenOptions = document.getElementById("yonghupingfenSelect").options;
			var yonghupingfenSelectedOption = yonghupingfenOptions[yonghupingfenIndex]
			if(yonghupingfenSelectedOption.text != null && yonghupingfenSelectedOption.text != ''){
				searchForm.yonghupingfen = "%" + yonghupingfenSelectedOption.text + "%";
			}
        ...
        function getDataList() {
			http("dingdanpingjia/page","GET",{
				...
				yonghupingfen : searchForm.yonghupingfen,	
		...
		function shangpinmingchengSelect(){
			//填充下拉框选项
			http("option/shangpinxinxi/shangpinmingcheng","GET",{},(res)=>{
				if(res.code == 0){
					shangpinmingchengOptions = res.data;
					var nullOption = document.createElement('option');
					var shangpinmingchengSelect = document.getElementById('shangpinmingchengSelect');
					shangpinmingchengSelect.appendChild(nullOption);
					for(var i=0;i<shangpinmingchengOptions.length;i++){
						var shangpinmingchengOption = document.createElement('option');
						shangpinmingchengOption.setAttribute('name','shangpinmingchengOption');
						shangpinmingchengOption.setAttribute('value',shangpinmingchengOptions[i]);
						shangpinmingchengOption.innerHTML = shangpinmingchengOptions[i];
						shangpinmingchengSelect.appendChild(shangpinmingchengOption);
					}
				}
			});
		}
