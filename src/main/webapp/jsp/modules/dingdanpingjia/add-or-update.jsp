...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>商品名称</label>
										<select id="shangpinmingchengSelect" name="shangpinmingcheng" class="form-control">
										</select>	
									</div>	
									<div class="form-group col-md-6">
										<label>用户评分</label>
	...
	<script>
					...
					http("option/shangpinxinxi/shangpinmingcheng","GET",{},(res)=>{
						if(res.code == 0){
							...
							for(var i=0;i<shangpinmingchengOptions.length;i++){
								...
								if(ruleForm.shangpinmingcheng == shangpinmingchengOptions[i]){
									shangpinmingchengOption.setAttribute('selected','selected');
								}
		...
		function dataBind(){
			...
			var shangpinmingchengOptions = document.getElementsByClassName("shangpinmingchengOption");
			for(var shangpinmingchengCount = 0; shangpinmingchengCount < shangpinmingchengOptions.length;shangpinmingchengCount++){
				if(shangpinmingchengOptions[shangpinmingchengCount].getAttribute('value') == ruleForm.shangpinmingcheng){
					shangpinmingchengOptions[shangpinmingchengCount].setAttribute('selected','selected');
				}
			}
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					var shangpinmingchengOptions = document.getElementsByClassName("shangpinmingchengOption");
						for(var shangpinmingchengCount = 0; shangpinmingchengCount < shangpinmingchengOptions.length;shangpinmingchengCount++){
							if(shangpinmingchengOptions[shangpinmingchengCount].getAttribute('value') == res.data.shangpinmingcheng){
								shangpinmingchengOptions[shangpinmingchengCount].setAttribute('selected','selected');
							}
						}
					}
