...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<select name="fenlei" id="fenleiSelect" class="form-control form-control-sm" aria-controls="tableId">
									</select>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('chandi')">产地<i id="chandiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			...
			var fenleiIndex = document.getElementById("fenleiSelect").selectedIndex;
			var fenleiOptions = document.getElementById("fenleiSelect").options;
			var fenleiSelectedOption = fenleiOptions[fenleiIndex]
			if(fenleiSelectedOption.text != null && fenleiSelectedOption.text != ''){
				searchForm.fenlei = "%" + fenleiSelectedOption.text + "%";
			}
			getDataList();
		}		
		// 获取数据列表
		...
		function setDataRow(item,number){
			...
			var chandiCell  = document.createElement('td');

						 chandiCell.innerHTML = item.chandi;


			row.appendChild(chandiCell);
